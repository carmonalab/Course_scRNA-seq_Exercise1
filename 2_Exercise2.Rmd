...
```{r, message=FALSE, warning=F}
brca.data = ReadMtx(file.path(path_data, "matrix.mtx"),
                    file.path(path_data, "barcodes.tsv"),
                    file.path(path_data, "genes.tsv"))
...
rm(obj.sample_from_other_study1, obj.sample_from_other_study2)
gc()
