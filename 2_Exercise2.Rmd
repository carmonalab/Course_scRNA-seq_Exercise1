...
In this case we will select a collection of gating models intented to classify cells from the tumor micro-environment at high-resolution, called "TME_HiRes"
...
TODO: Perhaps run first a single sample to provide a simpler example, separating the classification step, from the visualization.
...
what is obj.list[[1]]@misc$batch.metadata
