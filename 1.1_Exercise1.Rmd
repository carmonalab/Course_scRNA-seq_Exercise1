...
pbmc.data <- Read10X(data.dir = "./data/Exercise1/")
...
```{r}
saveRDS(pbmc, file = "./output/obj_exercise_1.rds")
```
...
-   Tip: pick one or two marker genes that most strongly differentiate it from all other clusters and google it. Or even better:\
    A very good resource for protein and RNA profiles is the [Human Protein Atlas](https://www.proteinatlas.org/)\
    For example: [Human Protein Atlas result for gene "S100A9" expression in immune cells](https://www.proteinatlas.org/ENSG00000163220-S100A9/immune+cell)
